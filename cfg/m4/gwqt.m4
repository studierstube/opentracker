...
if test x"$QTDIR" = x ; then
    QT_SEARCH="/usr/lib/qt31 /usr/local/qt31 /usr/lib/qt3 /usr/local/qt3 /usr/lib/qt2 /usr/local/qt2 /usr/lib/qt /usr/local/qt /usr/share/qt3 /usr/share/qt4"
...
# # [chris,200512]: want full path to moc
...
# # [chris,200512]: want full path to uic
