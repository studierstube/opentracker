...
dnl
dnl @version $Id: ac_cxx_have_std.m4,v 1.2 2003/01/14 18:38:44 tamer Exp $
...
dnl HAVE_NAMESPACES.
dnl
dnl @version $Id: ac_cxx_namespaces.m4,v 1.2 2003/01/14 18:38:44 tamer Exp $
dnl @author Luc Maisonobe
dnl
...
dnl
dnl @version $Id: ac_cxx_have_stl.m4,v 1.2 2003/01/14 18:38:44 tamer Exp $
dnl @author Luc Maisonobe
dnl
...
dnl
dnl @version $Id: ac_cxx_typename.m4,v 1.2 2003/01/14 18:38:44 tamer Exp $
dnl @author Luc Maisonobe
dnl
...
# < $sim_ac_sogtk_includedir  (location of SoGtk headers)
...
# AC_ARG_WITH([sogtk], AC_HELP_STRING([--without-sogtk], [disable use of SoGtk]))
# AC_ARG_WITH([sogtk], AC_HELP_STRING([--with-sogtk], [enable use of SoGtk]))
AC_ARG_WITH([sogtk],
...
if $sim_ac_sogtk_desired; then
  ...
  if $sim_ac_sogtk_configcmd; then
    ...
    sim_ac_sogtk_includedir=`$sim_ac_sogtk_configcmd --includedir`
