...
void SERVER_DISPATCH_APIENTRY crServerDispatchBoundsInfoCR( const GLrecti *bounds, const GLbyte *payload, GLint len, GLint num_opcodes );
...
GLint SERVER_DISPATCH_APIENTRY crServerDispatchCreateContext( const char *dpyName, GLint visual );
