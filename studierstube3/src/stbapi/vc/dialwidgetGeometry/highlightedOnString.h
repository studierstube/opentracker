...
char *SoVCDialWidgetKit::widgetHighlightedOnString=
"Separator {"
"           DEF geomTransp TransparencyType { value SORTED_OBJECT_SORTED_TRIANGLE_BLEND }"
"           DEF geomFile File { name ../../src/stbapi/vc/dialwidgetGeometry/halfsphere_highon.iv }"
