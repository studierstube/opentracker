...
/** Class definition for SoAbortGroup
  ...
  *
  * $Id: SoAbortGroup.h 3425 2004-07-14 12:09:17Z tamer $
  * @file                                                                   */
 /* ======================================================================= */
 ...
 * @author Hermann Wurnig, Gerd Hesina, Gerhard Reitmayr
 */
class STBAPI_API SoAbortGroup : public SoGroup {
...
protected:
    ...
    /**  
     * static action for the Handle3DEvent action to avoid having to derive
     * and deal with Base3D. It will call directly doAction on the node.
     */
