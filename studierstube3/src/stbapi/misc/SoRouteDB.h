 ...
 * ======================================================================== */
/** header file for SoRouteDB engine
  *
  * @author Gerhard Reitmayr
  *
  * $Id: SoRouteDB.h 3425 2004-07-14 12:09:17Z tamer $
  * @file                                                                   */
 /* ======================================================================= */
...
/** 
 * The SoRouteDB class is a small utility node to debug field values and routes.
 ...
 * @author Gerhard Reitmayr
 */
class STBAPI_API SoRouteDB : public SoNode {
...
public:
   // Fields:
    ...
    /// the name of the SoRouteDB, will be used in the output
    SoSFString name;
