 ...
 * 
 * $Id: SoFileSubgraph.h 3520 2004-07-21 07:49:00Z tomp $
 * @file
 */
/* ======================================================================== */
...
/** Nodekit to load in a scenegraph from a file that can be attached to a node in 
    ...
    @ingroup util
 */
class STBAPI_API SoFileSubgraph: public SoBaseKit
{
...
public:
    ...
    /// node that the filegraph should be put in (leaving root empty !!)
	/// must be of type SoGroup !!
