 ...
 *
 * $Id: SoFanIn.h 4038 2004-11-23 13:17:02Z tomp $
 * @file                                                                   */
/* ======================================================================= */
...
@ingroup util
*/
class STBAPI_API SoFanIn : public SoEngine {
...
public:
	...
	/**
	* returns the next unconnected 'in' field (in0, in1, ....) or NULL if all fields are connected. 
	* @return the next unconnected 'in' field (in0, in1, ....) or NULL if all fields are connected.
	*/
    SoField *getNextUnconnectedField() const;
	
	/**
	returns the next unconnected field of a SoTriggerAny or SoFanIn engine. 
	Assert that SoEngine * is of either type and not NULL
	*/
	SoField *getNextUnconnectedField(SoEngine *engine);

    static SoField *getNextUnconnectedFieldFromEngine(const SoEngine *engine);
protected:
