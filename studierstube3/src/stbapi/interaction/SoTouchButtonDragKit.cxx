 ...
 * ======================================================================== */
/** 3D Dragger for "magic wand" with button
  *
  * @author Jan Prikryl
  *
  * $Id: SoTouchButtonDragKit.cxx 3425 2004-07-14 12:09:17Z tamer $
  * @file                                                                   */
 /* ======================================================================= */
...
#include "SoTouchButtonDragKit.h"

SO_KIT_SOURCE(SoTouchButtonDragKit);
BASE3D_SOURCE(SoTouchButtonDragKit);

//----------------------------------------------------------------------------

void
SoTouchButtonDragKit::initClass(void)
{
    SO_KIT_INIT_CLASS(SoTouchButtonDragKit, SoBaseKit, "BaseKit");
    BASE3D_INIT_CLASS(SoTouchButtonDragKit);
}
...
SoTouchButtonDragKit::SoTouchButtonDragKit()
:
    highlighted(FALSE),
    doDragging(FALSE),
    pressCallback(NULL),
...
{
    SO_KIT_CONSTRUCTOR(SoTouchButtonDragKit);
...
SbBool 
SoTouchButtonDragKit::isInterested(SoHandle3DEventAction *h3a)
{
...
//-----------------------------------------------------------------------------
// SoTouchButtonDragKit::handle3DEvent(SoHandle3DEventAction* h3a)
...
SoTouchButtonDragKit::handle3DEvent(SoHandle3DEventAction* h3a)
{
    ...
    SbBool buttonPressed = ev->getButton(STB_PRIMARY_BUTTON);
    ...
    {
        // pen inside geometry but no button pressed
        if ( inside )
        {
            doDragging = FALSE;
            highlighted = TRUE;
...
void 
SoTouchButtonDragKit::update(SbVec3f  transIn, SbRotation  rotIn,
...
void
SoTouchButtonDragKit::writeBack(SbVec3f trans, SbRotation rot)
{
    /*
    float tmp[3];
...
void
SoTouchButtonDragKit::setPressCallback(SoTouchButtonDragKitCB* cb, void* userData)
{
    pressCallback = cb;
...
void
SoTouchButtonDragKit::setReleaseCallback(SoTouchButtonDragKitCB* cb, void* userData)
{
    releaseCallback = cb;
...
void
SoTouchButtonDragKit::setMoveCallback(SoTouchButtonDragKitCB* cb, void* userData)
{
    moveCallback = cb;
...
void
SoTouchButtonDragKit::removePressCallback()
{
...
void
SoTouchButtonDragKit::removeReleaseCallback()
{
...
void
SoTouchButtonDragKit::removeMoveCallback()
{
