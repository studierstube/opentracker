...
//  HISTORY:
//
//  02-Oct-00 13:17:45  jp  last modification
//  02-Oct-00 12:15:32  jp  hysteresis field
//  20-Sep-00 11:58:25  jp  copied template from SoDragKit.h
// ===========================================================================

#ifndef _SOTOUCHDRAGKIT_H_
#define _SOTOUCHDRAGKIT_H_
...
class STBAPI_API SoTouchDragKit;

typedef void SoTouchDragKitCB(void* userData, SoTouchDragKit* dragKit);
...
public:
    ...
    SoTouchDragKit(                          //constructor
        );
    ~SoTouchDragKit(                         //destructor
        );
...
private:
    ...
    SoTouchDragKitCB * pressCallback;
    SoTouchDragKitCB * releaseCallback;
    SoTouchDragKitCB * moveCallback;

    void * pressCallbackData;
    void * releaseCallbackData;
    void * moveCallbackData;
    
}; //class SoTouchDragKit

#ifdef WIN32
#include <SoWinEnterScope.h>
#endif

#endif//_SoTouchDragKit_H_
