 ...
 * ======================================================================== */
/** class definition for SoTooltipKit
  *
  * base class for scene objects the user can interact with
  *
  * @author  Thomas Psik
  *
  * $Id: SoTooltipKit.h 4047 2004-11-25 12:34:27Z tomp $
  * @file                                                                   */
 /* ======================================================================= */
 ...
 *
 * The SoTooltipKit uses a SoLabelKit to display the text on the plane.
 *
...
SoTooltipKit { text "This is a tooltip" show TRUE}			# shows a tooltip 
...
SoPushButton 
  {
	tooltip SoTooltipKit { text "This is a push button" }  # tooltip will be activated when user is within the pushbutton
  }
...
class STBAPI_API SoTooltipKit : public SoBaseKit {

	SO_KIT_HEADER(SoTooltipKit);
...
public:
	...
	SoSFTrigger	  startShow;
	SoSFTrigger   stopShow;
	...
	///
//	void adaptToTemplate(SoTooltipKit *tooltipTempl);
	
	/// a stupid helper function (could not find another way ??)
	void addToBase(SoNode *); 

	/// set other tooltip to be activated (used in composed widgets like SoIncrementalSlider)
	void setMasterTooltip(SoTooltipKit *); 
	SoTooltipKit *getMasterTooltip() {return masterTooltip;}
