 ...
 * ======================================================================== */
//  PROJECT:    Studierstube
//  CONTENT:    SoBase3DTouchSlider - implementation
//  VERSION:    2.0
// ===========================================================================
...
//  HISTORY:
//
//  28-Sep-00 11:29:58  jp      last change
//  28-Sep-00 11:27:21  jp      copied template from SoBase3DSlider.h
// ===========================================================================
#ifndef __SoBase3DTouchSlider_H__
#define __SoBase3DTouchSlider_H__
 ...
 * @ingroup deprecated
 */
class STBAPI_API SoBase3DTouchSlider : public SoBaseKit, public Base3D {

	SO_KIT_HEADER(SoBase3DTouchSlider);
  ...
  public:
	...
	void		setSliderHighlighted(SbBool highlightB);
	SbBool		isSliderHighlighted();
	void		setBodyHighlighted(SbBool highlightB);
