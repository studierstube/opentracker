 ...
 *
 */
class STBAPI_API ACE_RMCast_Receiver_Module : public ACE_RMCast_Module
{
public:
  //! Constructor
...
inline ACE_RMCast_Receiver_Module::ACE_RMCast_Receiver_Module (void)
  :  state_ (ACE_RMCast_Receiver_Module::RS_JOINING)
{
}
