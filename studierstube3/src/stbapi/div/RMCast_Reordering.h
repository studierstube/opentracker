 ...
 *
 */
class STBAPI_API ACE_RMCast_Reordering : public ACE_RMCast_Module
{
public:
  /// Constructor
...
private:
  ...
  int push_queued_messages (int * must_ack);
...
protected:
  ...
  /// time out to wait before we send an nack
  ACE_Time_Value lastNack;
};

inline ACE_RMCast_Reordering::ACE_RMCast_Reordering (void)
  :  next_expected_ (0)
  ,  highest_received_ (0)
{
}
