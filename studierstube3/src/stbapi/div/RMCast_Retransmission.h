 ...
 */
class STBAPI_API ACE_RMCast_Retransmission : public ACE_RMCast_Module
{
public:
  ...
  /// Return number of messages in retransmission
...
protected:
  ...
  /// time stamp for retransmission suppression
  ///ACE_Time_Value lastResend;

  /// highest sent packet number
  ACE_UINT32 highest_sent_;

  /// highest ack received
  ACE_UINT32 highest_ack_;
};

inline ACE_RMCast_Retransmission::ACE_RMCast_Retransmission (void) 
: highest_sent_(0),highest_ack_(0)
{
}
