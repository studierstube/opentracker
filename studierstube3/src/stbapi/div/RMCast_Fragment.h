 ...
 */
class STBAPI_API ACE_RMCast_Fragment : public ACE_RMCast_Module
{
public:
  //! Constructor
   ...
   */
  virtual int data (ACE_RMCast::Data &received_data);
...
inline size_t ACE_RMCast_Fragment::max_fragment_size (void) const
{
