 ...
 */
class STBAPI_API ACE_RMCast_UDP_Event_Handler : public ACE_Event_Handler
{
public:
  //! Constructor, save io_udp as the Adaptee in the Adapter pattern.
	ACE_RMCast_UDP_Event_Handler (ACE_RMCast_IO_UDP *io_udp, bool udp = true);
...
private:
  ...
  //! flag deciding between udp or multicast handle
  bool udp_;
};

inline ACE_RMCast_UDP_Event_Handler::ACE_RMCast_UDP_Event_Handler (ACE_RMCast_IO_UDP *io, bool udp)
  :  io_udp_ (io), udp_( udp )
{
}
