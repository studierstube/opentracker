 ...
 */
class STBAPI_API ACE_RMCast_Proxy : public ACE_RMCast_Module
{
public:
    //! Constructor
    ...
    */
    ...
    const ACE_Time_Value & getLastTimeStamp(void) const;


protected:    
    /// the timestamp for last message received
...
inline ACE_RMCast_Proxy::ACE_RMCast_Proxy (void)
: next_expected_ (0)
, highest_received_ (0)
{
}

inline const ACE_Time_Value & ACE_RMCast_Proxy::getLastTimeStamp(void) const
{
    return last_time;
}
