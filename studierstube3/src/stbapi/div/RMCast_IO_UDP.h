...
class STBAPI_API ACE_RMCast_IO_UDP : public ACE_RMCast_Module
{
public:
  //! Constructor
  /*!
  ...
  ACE_HANDLE get_handle_udp (void) const;

  ACE_HANDLE get_handle_mcast (void) const;
...
private:
  ...
  //! The socket used to receive data from the multicast group
  ACE_SOCK_Dgram_Mcast mgram_;

  //! The socket used to send data either as sender or responses as receiver
