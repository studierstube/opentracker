...
static struct hashentry ttable[2][ttblsz];
#endif /* ttblsz */
...
void SelectMove (short int side, short int iop,ChessKit *ck)
...
int
parse (FILE *fd, unsigned short int *mv, short int side)
{
  int c, i, r1, r2, c1, c2;
  char s[100];
  while ((c = getc (fd)) == ' ') ;
...
#define BOOK "../apps/chess/gnuchess.book"
