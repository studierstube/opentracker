...
# ADD CPP /nologo /G6 /MDd /W3 /GX /ZI /Od /I "$(ACEROOT)" /I "$(XERCESCROOT)/include" /I "$(STBROOT)/src" /I "$(COINROOT)\INCLUDE" /I "$(COINROOT)\INCLUDE\INVENTOR" /I "../" /D "HA" /D "WIN32" /D "BOTANIC_VIS_EXPORTS" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "USE_COIN" /D "COIN_DLL" /FR /YX /FD /GZ /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x407 /d "_DEBUG"
# ADD RSC /l 0x407 /d "_DEBUG"
...
# ADD LINK32 coin2d.lib aced.lib xerces-c_2d.lib stbapid.lib /nologo /dll /incremental:no /debug /machine:I386 /out:"../../../lib/BotanicVisd.dll" /pdbtype:sept /libpath:"$(COINROOT)\LIB" /libpath:"$(ACEROOT)/ace" /libpath:"$(XERCESCROOT)/lib" /libpath:"$(STBROOT)/lib"
