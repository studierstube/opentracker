...
# ADD CPP /nologo /G6 /MD /W3 /GR /GX /O2 /I "extras" /I "$(ACEROOT)" /I "$(XERCESCROOT)/include" /I "extras/intersense" /I "$(ARTOOLKITROOT)/include" /I "../wintab/include" /I "$(VRPNROOT)/vrpn" /I "$(ARTOOLKITPLUSROOT)/include" /I "$(TINYXMLROOT)" /D "OS_WIN32" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OPENTRACKER_EXPORTS" /YX /FD /c
