...
# ADD CPP /nologo /GB /MDd /W3 /Gm /Gi /GR /GX /ZI /Od /I "extras" /I "$(ACEROOT)" /I "$(XERCESCROOT)/src" /I "extras/intersense" /I "$(ARTOOLKITROOT)/include" /I "../wintab/include" /I "$(VRPNROOT)/vrpn" /I "$(ARTOOLKITPLUSROOT)/include" /I "$(TINYXMLROOT)" /I "$(OPENVIDEOROOT)/src/vidcapture" /D "OS_WIN32" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OPENTRACKER_EXPORTS" /FR /FD /GZ /c
# SUBTRACT CPP /YX
