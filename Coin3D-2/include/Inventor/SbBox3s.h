...
public:
  ...
  /* FIXME: add these functions in as part of the API from 2.4.0 and
     onwards, by enabling the COIN_DLL_API keywords. 20040708 mortene. */
#if COIN_MINOR_VERSION > 3
#error The below functions should be added to the API properly from Coin 2.4.
#endif
