...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE_RMCast.lib Test_Output.lib ACE.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Release\RMCast_Reassembly_Test.pdb"  /machine:I386 /out:"Release\RMCast_Reassembly_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE_RMCastd.lib Test_Outputd.lib ACEd.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:".\RMCast_Reassembly_Test.pdb" /debug /machine:I386 /out:".\RMCast_Reassembly_Test.exe"
