...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Output.lib ACE.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Release\SOCK_Send_Recv_Test.pdb"  /machine:I386 /out:"Release\SOCK_Send_Recv_Test.exe"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO Test_Outputd.lib ACEd.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:".\SOCK_Send_Recv_Test.pdb" /debug /machine:I386 /out:".\SOCK_Send_Recv_Test.exe"
