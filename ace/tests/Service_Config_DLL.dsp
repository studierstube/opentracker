...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:windows /pdb:"..\lib\Service_Config_DLL.pdb" /dll  /machine:I386 /out:"..\lib\Service_Config_DLL.dll"
...
# ADD BSC32 /nologo /o"..\lib\Service_Config_DLL.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:windows /pdb:"..\lib\Service_Config_DLLd.pdb" /dll /debug /machine:I386 /out:"..\lib\Service_Config_DLLd.dll"
