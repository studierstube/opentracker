...
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:windows /pdb:"..\lib\Test_Output.pdb" /dll  /machine:I386 /out:"..\lib\Test_Output.dll"
...
# ADD BSC32 /nologo /o"..\lib\Test_Output.bsc"
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"..\lib" /nologo /version:5.4.2 /subsystem:windows /pdb:"..\lib\Test_Outputd.pdb" /dll /debug /machine:I386 /out:"..\lib\Test_Outputd.dll"
