...
!MESSAGE
!MESSAGE NMAKE /f "asnmp_tests_Address_Test_Static.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "asnmp_tests_Address_Test_Static.mak" CFG="asnmp_tests_Address_Test_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "asnmp_tests_Address_Test_Static - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO asnmps.lib ACEs.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Release\Address_Test.pdb"  /machine:I386 /out:"Static_Release\Address_Test.exe"

!ELSEIF  "$(CFG)" == "asnmp_tests_Address_Test_Static - Win32 Debug"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO asnmpsd.lib ACEsd.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Debug\Address_Test.pdb" /debug /machine:I386 /out:"Static_Debug\Address_Test.exe"
