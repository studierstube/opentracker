...
!MESSAGE
!MESSAGE NMAKE /f "pinset_Static.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "pinset_Static.mak" CFG="pinset_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "pinset_Static - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Release\pout.pdb"  /machine:I386 /out:"Static_Release\pout.exe"

!ELSEIF  "$(CFG)" == "pinset_Static - Win32 Debug"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Debug\pout.pdb" /debug /machine:I386 /out:"Static_Debug\pout.exe"
...
BuildCmds= \
	PATH=%PATH%;..\..\..\lib \
	..\..\..\bin\gperf -a -o -S2 -p $(InputPath) > pascal.cpp \
