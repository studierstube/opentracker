...
!MESSAGE
!MESSAGE NMAKE /f "iinset.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "iinset.mak" CFG="iinset - Win32 Debug"
!MESSAGE
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Release\iout.pdb"  /machine:I386 /out:"Release\iout.exe"

!ELSEIF  "$(CFG)" == "iinset - Win32 Debug"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:".\iout.pdb" /debug /machine:I386 /out:".\iout.exe"
