...
!MESSAGE
!MESSAGE NMAKE /f "C++NPv2_Select_Reactor_Log_Server.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "C++NPv2_Select_Reactor_Log_Server.mak" CFG="C++NPv2_Select_Reactor_Log_Server - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "C++NPv2_Select_Reactor_Log_Server - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Release\select_reactor_loggin_server.pdb"  /machine:I386 /out:"Release\select_reactor_loggin_server.exe"

!ELSEIF  "$(CFG)" == "C++NPv2_Select_Reactor_Log_Server - Win32 Debug"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib /libpath:"..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:".\select_reactor_loggin_server.pdb" /debug /machine:I386 /out:".\select_reactor_loggin_server.exe"
