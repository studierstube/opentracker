...
!MESSAGE
!MESSAGE NMAKE /f "Simple2_Static.mak" CFG="Simple2_Static - Win32 Debug"
!MESSAGE
...
!IF  "$(CFG)" == "Simple2_Static - Win32 Release"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEs.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Release\Simple2.pdb"  /machine:I386 /out:"Static_Release\Simple2.exe"

!ELSEIF  "$(CFG)" == "Simple2_Static - Win32 Debug"
...
# ADD BSC32 /nologo 
LINK32=link.exe
# ADD LINK32 advapi32.lib user32.lib /INCREMENTAL:NO ACEsd.lib /libpath:"..\..\..\lib" /nologo /version:5.4.2 /subsystem:console /pdb:"Static_Debug\Simple2.pdb" /debug /machine:I386 /out:"Static_Debug\Simple2.exe"
