...
/** header file for JoystickModule module.
  ...
  *
  * $Header: /scratch/subversion/cvs2svn-0.1236/../cvs/opentracker/src/input/JoystickModule.h,v 1.1 2001/12/11 13:30:51 splechtna Exp $
  * @file                                                                   */
 /* ======================================================================= */
...
public:
    /** constructor method. */
    JoystickModule() : ThreadModule(), NodeFactory()
    {
    };
