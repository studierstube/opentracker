...
# ADD LINK32 opentracker.lib /nologo /subsystem:console /machine:I386 /out:"../../bin/opentracker.exe" /libpath:"../../lib"
...
# ADD LINK32 opentrackerd.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../bin/opentrackerd.exe" /pdbtype:sept /libpath:"../../lib"
