...
#define IT_COM_NUM_LIST_CODES       13
...
IS_BOOL ISD_setOutputRecordList( InterSenseTrackerType *, ISD_STATION_CONFIG_TYPE *, WORD );
IS_BOOL ISD_configureTracker( InterSenseTrackerType *tracker, IS_BOOL verbose );
IS_BOOL ISD_allowUserCommand( char * );
