...
IS_BOOL itComUpdateStationStat( InterSenseTrackerType *tracker, DWORD sensorNum );
IS_BOOL itComUpdateSensorStat( InterSenseTrackerType *tracker, DWORD sensorNum );
IS_BOOL itComUpdateIntrackSystemStat( InterSenseTrackerType *tracker, float timeOut );
IS_BOOL itComUpdateOutputList( InterSenseTrackerType *tracker, DWORD sensorNum );
IS_BOOL itComUpdatePredictionString( InterSenseTrackerType *tracker, DWORD sensorNum );
