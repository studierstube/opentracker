...
*
*       Copyright:      InterSense 2000 - All rights Reserved.
*
...
BOOL  ISLIB_GetTrackerConfig( ISD_TRACKER_HANDLE, ISD_TRACKER_INFO_TYPE *, BOOL verbose );
...
BOOL  ISLIB_SetTrackerConfig( ISD_TRACKER_HANDLE, ISD_TRACKER_INFO_TYPE *, BOOL verbose );
...
BOOL  ISLIB_GetCommInfo( ISD_TRACKER_HANDLE, ISD_TRACKER_INFO_TYPE * );
...
BOOL  ISLIB_SetStationConfig( ISD_TRACKER_HANDLE, ISD_STATION_INFO_TYPE *, 
...
BOOL  ISLIB_GetStationConfig( ISD_TRACKER_HANDLE, ISD_STATION_INFO_TYPE *, 
                              WORD stationNum, BOOL verbose );
...
BOOL  ISLIB_ResetAngles( ISD_TRACKER_HANDLE, float yaw, float pitch, float roll );
