...
// ==========================================================================================
  ...
  if samp1 = nil then
  begin
    writeln('Error! Loading drumloop.wav');
    writeln(FMOD_ErrorString(FSOUND_GetError()));
    FSOUND_Close();
    exit;
  end;
   ...
   // 8bit
  samp2 := FSOUND_Sample_Load(FSOUND_FREE, '../../media/jungle.wav', FSOUND_2D, 0, 0);
  if samp2 = nil then
  begin
    writeln('Error! Loading jungle.wav');
    writeln(FMOD_ErrorString(FSOUND_GetError()));
    FSOUND_Close();
    exit;
  end;
  ...
  if samp2 = nil then
  begin
    writeln('Error! Loading chimes.wav');
    writeln(FMOD_ErrorString(FSOUND_GetError()));
    FSOUND_Close();
    exit;
  end;
