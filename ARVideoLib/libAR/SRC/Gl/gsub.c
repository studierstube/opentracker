...
/*
		glViewport( 0,                    (int)(gZoom*gImYsize),
                   (int)(gZoom*gImXsize), gWinYsize-(int)(gZoom*gImYsize));
*/
    }
    else {
...
//				[pintaric]
				glTexCoord2d( px, gImYsize - py/size_adjust_factor ); glVertex3d( xx1, yy1, z );
                glTexCoord2d( px, gImYsize - qy/size_adjust_factor ); glVertex3d( xx2, yy2, z );
            }
            glEnd();
        }
        glEndList();
