...
// char *vconf = "deviceName=Microsoft DV Camera,deinterlaceState=on,deinterlaceMethod=blend,"
//               "pixelFormat=PIXELFORMAT_RGB32";
//char *vconf = "showDlg,deviceName=Microsoft DV Camera,pixelFormat=PIXELFORMAT_RGB32";
char *vconf = "showDlg";
...
static void draw( void )
{
	...
	glScalef(1,-1,1); // correct for Y-flipping [pintaric]
